 ...
 */
"use strict";
var chalk, error, iGap, oOptions, path, pkg, program, sPath, sSinceCommit, sSystem, sUser, spinner, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
...
(program = require("commander")).version(pkg.version).usage("[options]").description("Compute approximate development time spent on a project, using logs from version control system.").option("-s, --system <system>", "force the version system to analyse (by default, try to guess)").option("-g, --gap <amount>", "number of minutes above wich the time between two commits is ignored in the total.", 120).option("-u, --user <user>", "use only the commits of the given user.").option("-r, --raw", "show raw result, as number of minutes spent on the project.").option("-c, --commit <commit>", "compute the result since the given commit.").parse(process.argv);
...
sSinceCommit = (_ref5 = program.commit) != null ? _ref5 : false;
